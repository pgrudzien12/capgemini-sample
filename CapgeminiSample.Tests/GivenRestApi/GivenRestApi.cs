...
namespace CapgeminiSample.Tests.CustomersController
{
    public class GivenRestApi
    {
        ...
        protected static StringContent ToHttpContent(CustomerDTO c)
        {
        ...
        protected async Task<CustomerDTO> Insert(CustomerDTO customer)
        {
        ...
        protected async Task<CustomerDTO> Get(int id)
        {
            ...
            return JsonConvert.DeserializeObject<CustomerDTO>(customer);
        }
    }
}
